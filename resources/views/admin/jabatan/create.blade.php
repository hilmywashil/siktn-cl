...
@section('title', 'Tambah Master Jabatan')
@section('page-title', 'Tambah Master Jabatan')
...
<div class="content-header" style="margin-bottom: 24px;">
    <h2 style="font-size: 1.5rem; font-weight: 700; color: #0a2540;">Tambah Jabatan</h2>
    <p class="text-muted" style="margin-top: 5px; color: #6b7280; font-size: 0.875rem;">Tambahkan posisi atau jabatan baru ke dalam sistem.</p>
</div>
