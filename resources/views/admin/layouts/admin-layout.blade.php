                            ...
                            @forelse($filteredNotifications as $notification)
                                ...
                                <a href="{{ $targetUrl }}" data-category="{{ $categoryTag }}" class="notification-item {{ $notification->read_at ? '' : 'unread' }}">
                                    <div class="notification-item-title">
                                        ...
                                        @elseif($notifType == 'surat_pending' || $notifType == 'program_join_pending')
                                            <svg viewBox="0 0 24 24" width="14" height="14" stroke="#d97706" fill="none" stroke-width="2" style="margin-right: 4px; vertical-align: middle;"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><polyline points="16 11 18 13 22 9"></polyline></svg>
