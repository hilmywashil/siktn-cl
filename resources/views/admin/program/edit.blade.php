                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-select select2-basic @error('kategori') error @enderror" required>
                            ...
                            <option value="Bidang" {{ old('kategori', $program->kategori) == 'Bidang' ? 'selected' : '' }}>Program Kerja (Internal)</option>
                        </select>
                        @error('kategori')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                            ...
                            <select name="program_kerja_id" id="program_kerja_id" class="form-select select2-basic" style="width: 100%;">
                                ...
                                @if(isset($programKerjas))
                                    @foreach($programKerjas as $pk)
                                        <option value="{{ $pk->id }}" {{ old('program_kerja_id', $program->program_kerja_id) == $pk->id ? 'selected' : '' }}>
                                            {{ $pk->nama_program }}
                                        </option>
                                    @endforeach
                                @endif
