    ...
    <div class="sidebar-header">
        <div class="brand">
            ...
            <div class="brand-text" style="margin-left: 20px;">
                ...
                <div class="brand-subtitle" style="color: #c59217; font-weight: 700; letter-spacing: 1px;">INDONESIA</div>
            </div>
        </div>
    </div>
        ...
        <div class="menu-section">
            ...
            <div class="menu-dropdown">
                ...
                <div class="submenu {{ in_array($activeMenu, ['jabatan', 'anggota', 'list-anggota', 'kontak']) ? 'active' : '' }}">
                    ...
                    @if($admin->isSuperAdmin() || $admin->isPNKT() || $admin->category === 'pnkt')
                    <a href="{{ route('admin.verifikasi-jabatan.index') }}" class="submenu-item {{ $activeMenu === 'verifikasi_jabatan' ? 'active' : '' }}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                            <polyline points="22 4 12 14.01 9 11.01"></polyline>
                        </svg>
                        <span>Verifikasi Jabatan</span>
                    </a>
                    @endif
                    ...
                    @endif
                    <a href="{{ route('admin.settings.periode.index') }}" class="submenu-item {{ $activeMenu === 'pengaturan_periode' ? 'active' : '' }}">
            ...
            @if($admin->isSuperAdmin() || $admin->isPimpinan() || $admin->isPNKT())
            <div class="menu-dropdown">
                <div class="menu-item has-dropdown {{ in_array($activeMenu, ['pengaturan_notifications', 'settings_activity_logs', 'pengaturan_periode']) ? 'active' : '' }}" onclick="toggleDropdown(this)">
                    <div style="display: flex; align-items: center; gap: 1rem; flex: 1;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="3"></circle>
                            <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path>
                ...
                <div class="submenu {{ in_array($activeMenu, ['pengaturan_notifications', 'settings_activity_logs', 'pengaturan_periode']) ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.settings.activity-logs') }}" class="submenu-item {{ $activeMenu === 'settings_activity_logs' ? 'active' : '' }}">
