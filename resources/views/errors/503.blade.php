...
<body>
    <div class="container">
        ...
        <h2 class="error-title">Sistem Sedang Pemeliharaan</h2>
        <p class="error-desc">Sistem Karang Taruna saat ini sedang dalam proses pemeliharaan atau pembaruan. Silakan coba kembali beberapa saat lagi.</p>
    </div>
</body>
</html>
