                        ...
                        <div class="program-card">
                            ...
                            <div class="program-content">
                                ...
                                <div class="program-meta">
                                    ...
                                    @if($program->jabatan)
                                    <div class="meta-item">
                                        <i class="fa fa-sitemap meta-icon"></i>
                                        <span>Bidang: <strong>{{ $program->jabatan->nama_jabatan }}</strong></span>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <a href="{{ route('program.bidang.detail', $program->id) }}" class="btn-detail">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
