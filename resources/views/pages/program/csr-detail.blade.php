...
@section('title', 'Detail Program CSR - ' . $program->nama_program)
    ...
    <div class="tujuan-section">
        <div class="detail-wrapper">
            <div class="detail-header">
                <h2><i class="fa fa-file-alt"></i> Detail Program CSR</h2>
                <a href="{{ route('program.csr') }}" class="back-link">
            ...
            <div class="detail-content">
                ...
                <div class="detail-info">
                    ...
                    <div class="detail-meta-grid">
                        ...
                        <div class="detail-meta-item">
                            <div class="detail-meta-label">
                                <i class="fa fa-handshake" style="color: #b7830f;"></i> Mitra
                            </div>
                            <div class="detail-meta-value">{{ $program->mitra }}</div>
                        </div>
                        @endif
                        <div class="detail-meta-item">
                            <div class="detail-meta-label">
                        ...
                        <div class="detail-meta-item">
                            ...
                            <div class="detail-meta-value">CSR</div>
                        </div>
                    </div>
                    ...
                    @if($program->programKerja)
                        <div class="detail-desc-box" style="margin-top: 1.25rem; background: #f0f9ff; border: 1px solid #bae6fd; border-left: 4px solid #0284c7; border-radius: 10px; padding: 1.25rem;">
                            <div class="detail-desc-title" style="color: #0369a1; display: flex; align-items: center; gap: 8px; font-weight: 800; margin-bottom: 0.4rem;">
                                <i class="fa fa-link"></i> Terkoneksi Dengan Program Kerja Organisasi:
                            </div>
                            <div class="detail-desc-text">
                                <a href="{{ route('program.bidang.detail', $program->programKerja->id) }}" style="font-weight: 700; color: #022648; text-decoration: underline; font-size: 1rem; display: inline-flex; align-items: center; gap: 6px;">
                                    <i class="fa fa-chevron-right" style="color: #b7830f; font-size: 0.85rem;"></i> {{ $program->programKerja->nama_program }}
                                </a>
                            </div>
                        </div>
                    @endif
