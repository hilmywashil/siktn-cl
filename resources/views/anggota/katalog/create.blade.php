            ...
            <main class="dashboard-content">
                ...
                <form action="{{ route('anggota.katalog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint">Upload maksimal 3 gambar produk/layanan. Format: JPG, PNG, GIF (Max: 10MB per file)</div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="wilayah" id="wilayahSelect" class="form-control" style="width: 100%;" required>
                            ...
                            @php $currentWilayah = old('wilayah', $anggota->domisili ?? ''); @endphp
                            @if($currentWilayah)
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const currentWilayah = "{{ old('wilayah', $anggota->domisili ?? '') }}";
