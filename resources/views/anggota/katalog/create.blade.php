...
@section('title', 'Tambah Katalog Perusahaan')
        ...
        <div class="dashboard-grid">
            ...
            <main class="dashboard-content">
                <div class="section-header-row">
                    <h2 class="section-title"><i class="fas fa-plus"></i> Tambah Data Katalog</h2>
                </div>

                <form action="{{ route('anggota.katalog.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="company_name">
                            ...
                            <span class="info-badge">Otomatis</span>
                        </label>
                        <input 
                            type="text" 
                            name="company_name" 
                            id="company_name"
                            class="form-control" 
                            value="{{ old('company_name', $anggota->nama_perusahaan ?? $anggota->nama_pimpinan) }}" 
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="business_field"
                            class="form-control" 
                            value="{{ old('business_field', is_array($anggota->produk_usaha_yang_akan_dijual) ? $anggota->produk_usaha_yang_akan_dijual[0] : '') }}" 
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5" placeholder="Ceritakan tentang bisnis Anda..." required>{{ old('description') }}</textarea>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="harga" id="harga" class="form-control" value="{{ old('harga') }}" placeholder="Contoh: Rp 50.000">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint">Upload maksimal 3 gambar produk/layanan. Format: JPG, PNG, GIF (Max: 2MB per file)</div>
                    ...
                    <div class="form-group">
                        <label for="address">
                            Alamat Kantor <span style="color: red;">*</span>
                            <span class="info-badge">Otomatis</span>
                        </label>
                        <textarea 
                            name="address" 
                            ...
                            class="form-control" 
                            rows="3" 
                            required>{{ old('address', $anggota->alamat_kantor) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="wilayah" id="wilayah" class="form-control" value="{{ old('wilayah') }}" placeholder="Contoh: Jawa Timur, Kabupaten Nganjuk">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="phone"
                            class="form-control" 
                            value="{{ old('phone', $anggota->telepon_wa_perusahaan) }}" 
                    ...
                    <div class="form-group">
                        <label for="email">
                            Email Bisnis <span style="color: red;">*</span>
                            <span class="info-badge">Otomatis</span>
                        </label>
                        <input 
                            type="email" 
                            ...
                            id="email"
                            class="form-control" 
                            value="{{ old('email', $anggota->email_website_perusahaan) }}"
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div class="form-group">
                            ...
                            <input type="url" name="website_url" id="website_url" class="form-control" value="{{ old('website_url') }}" placeholder="https://website.com">
                        </div>
                        <div class="form-group">
                            <label for="marketplace_url">Link Marketplace</label>
                            <input type="url" name="marketplace_url" id="marketplace_url" class="form-control" value="{{ old('marketplace_url') }}" placeholder="https://tokopedia.com/...">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-action-submit">
                            <i class="fas fa-save"></i> Simpan Data Katalog
                        </button>
